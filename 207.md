...
**Definition**: Let $f_{1}(x), \dots, f_{n}(x)$ be an ordered set of $n$ functions which are all differentiable at least $n-1$ times. The **Wrońskian** of these functions is the determinant expression
\begin{equation*}
...
**Definition**: A $n^{\text{th}}$ **order linear ODE** is an equation of the form
